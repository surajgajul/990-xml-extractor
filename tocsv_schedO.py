...
# Header for CSV
header = [
    'ID', 'FilerEIN', 'BusinessNameLine1Txt', 'BusinessNameControlTxt', 'FormAndLineReferenceDesc', 'ExplanationTxt'
]
        ...
        for filename in files:
            if filename.endswith('.xml'):
                ...
                if schedule_o is not None:
                    ...
                    # Find all SupplementalInformationDetail elements
